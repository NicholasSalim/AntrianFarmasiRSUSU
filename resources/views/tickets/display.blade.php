...
<div class="flex min-h-screen px-16 justify-between" style="padding-top: 100px; padding-bottom:50px; padding-left: 100px; padding-right:100px"> <!-- Ensuring both columns align properly -->
    ...
    <div class="flex flex-col items-start justify-center w-1/2"> <!-- Aligned left without extra padding -->
        ...
        <div class="bg-white p-24 rounded-3xl shadow-lg mb-8 w-3/4 text-center"> <!-- Reduced padding -->
            <p class="text-6xl font-bold text-gray-800" style="font-family: 'Urbanist', sans-serif;"> <!-- Reduced font size -->
...
<div class="w-1/2 flex flex-col pl-12">
    ...
    <div class="flex justify-center w-full mx-auto space-x-8 mt-4">
        @for ($col = 0; $col < 2; $col++)
